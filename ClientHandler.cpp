...
void ClientHandler::sendResponse(std::string response) {
...
void ClientHandler::setInformation(std::string info_file) {
    info_handler.setDefaultGetResponse(std::move(info_file));
}
